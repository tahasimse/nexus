 ...
 */
class getSecurity_Authenticator_FormLogin_DevService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authenticator.form_login.dev' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.form_login.dev'])) {
            return $container->privates['security.authenticator.form_login.dev'];
        }
        ...
        $c->setOptions(['login_path' => 'app_dev_login', 'default_target_path' => '/dev/dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
        $c->setFirewallName('dev');
        ...
        $d->setOptions(['login_path' => 'app_dev_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path']);

        return $container->privates['security.authenticator.form_login.dev'] = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($b, ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService')), $c, $d, ['login_path' => 'app_dev_login', 'check_path' => 'app_dev_login', 'enable_csrf' => true, 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, 'form_only' => false]);
    }
}
