 ...
 */
class getDeveloperProfileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeveloperProfileRepository' shared autowired service.
     *
     * @return \App\Repository\DeveloperProfileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeveloperProfileRepository.php';

        return $container->privates['App\\Repository\\DeveloperProfileRepository'] = new \App\Repository\DeveloperProfileRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
