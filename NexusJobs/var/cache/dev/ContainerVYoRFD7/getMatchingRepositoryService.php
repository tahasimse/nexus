 ...
 */
class getMatchingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MatchingRepository' shared autowired service.
     *
     * @return \App\Repository\MatchingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MatchingRepository.php';

        return $container->privates['App\\Repository\\MatchingRepository'] = new \App\Repository\MatchingRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
