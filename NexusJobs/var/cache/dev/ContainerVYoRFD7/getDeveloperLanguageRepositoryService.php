 ...
 */
class getDeveloperLanguageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeveloperLanguageRepository' shared autowired service.
     *
     * @return \App\Repository\DeveloperLanguageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeveloperLanguageRepository.php';

        return $container->privates['App\\Repository\\DeveloperLanguageRepository'] = new \App\Repository\DeveloperLanguageRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
