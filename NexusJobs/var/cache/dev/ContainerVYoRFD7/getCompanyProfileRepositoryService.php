 ...
 */
class getCompanyProfileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyProfileRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyProfileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyProfileRepository.php';

        return $container->privates['App\\Repository\\CompanyProfileRepository'] = new \App\Repository\CompanyProfileRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
